...
DO ON ERROR UNDO, THROW:
    ...
    REPEAT ON ERROR UNDO, LEAVE:
        ...
        IF v-field-count >= 7 THEN DO:
            ...
            IF NOT AVAILABLE BankDB.State THEN DO:
                CREATE BankDB.State.
                ASSIGN
            ...
            IF NOT AVAILABLE BankDB.City THEN DO:
                CREATE BankDB.City.
                ASSIGN
            ...
            IF NOT AVAILABLE BankDB.PostalCode THEN DO:
            ...
            IF v-record-count MODULO 50 = 0 THEN DO:
